  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2 text-[#0f0a2e]">
        ...
        <li>Univercity of ALberta software achitecture certificate</li>
        <li>HTML, CSS, and Javascript for Web Developers</li>
        <li>Meta front end developer certificate</li>
        <li>Meta back end developer certificate</li>
      </ul>
    ),
  },
];
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg text-[#1e1560]">
            ...
            working with JavaScript, React, Next.js, Node.js, Python, and more.
            I am a quick learner always looking to expand my knowledge and skill
            set.
          </p>
